...
A versão 1.6.0 do APK traz o novo ícone oficial do Fala+ e usa `https://fala-mais-api.onrender.com` como backend padrão. O usuário ainda informa somente o `FALA_MAIS_APP_TOKEN` no Perfil; a chave da OpenAI permanece no servidor.
